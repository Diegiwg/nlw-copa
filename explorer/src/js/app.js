...
class App {
    ...
    new_card(info) {
        ...
        info.jogos.forEach((jogo) => {
            ...
            jogos_html += `
                <c-box-times>
                    <img src="/explorer/static/icon/${jogo.time_1}.svg" alt="icon ${jogo.time_1}" id="${jogo.time_1}" />
                        ${jogo.horario}
                    <img src="/explorer/static/icon/${jogo.time_2}.svg" alt="icon ${jogo.time_2}" id="${jogo.time_2}" />
                </c-box-times>
            `;
        });
        //
...
function tutorial_1() {
    ...
    launch_toast({
        icon: "/explorer/static/favicon.svg",
